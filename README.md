...
- **[Práctica 3](practica-3.md)**: documento explicativo de dos cuadernos realizados en Python 3. Ambos se pueden encontrar en este mismo repositorio tanto en formato *html* como *ipynb*, tanto el correspondiente a la API del COVID-19 ([html](python-api-covid19-pandas.html), [ipynb](python-api-covid19-pandas.ipynb) como el del mapa de accidentes del municipio de Zaragoza ([html](api-pandas-folium.html), [ipynb](api-pandas-folium.ipynb)).
